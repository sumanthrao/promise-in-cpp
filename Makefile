...
$(EXEDIR)/run: $(ODIR)/client.o $(ODIR)/proxy.o $(ODIR)/scheduler.o $(ODIR)/task.o
	$(CC) -std=c++11 -pthread -o $(EXEDIR)/run -g $(ODIR)/client.o $(ODIR)/proxy.o $(ODIR)/scheduler.o $(ODIR)/task.o
...
$(ODIR)/proxy.o: $(SRCDIR)/proxy.cpp $(IDIR)/proxy.h
	$(CC) -std=c++11 -w -o $(ODIR)/proxy.o -c $(SRCDIR)/proxy.cpp

$(ODIR)/scheduler.o: $(SRCDIR)/scheduler.cpp $(IDIR)/scheduler.h
	$(CC) -std=c++11 -pthread -w -o $(ODIR)/scheduler.o -c $(SRCDIR)/scheduler.cpp

$(ODIR)/task.o: $(SRCDIR)/task.cpp $(IDIR)/task.h
	$(CC) -std=c++11 -w -o $(ODIR)/task.o -c $(SRCDIR)/task.cpp
